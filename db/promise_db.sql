...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 14, 2022 at 10:55 AM
...
('1201190003', '3', '0', 'RAIHAN NUR KHOTAMI', 'SE-02-02', 'ARD', '1920'),
('1201190004', '3', '0', 'ZULKARNAIN', 'SE-02-01', 'FWP', '1920'),
...
('1201190043', '3', '0', 'MUHAMMAD NAFI UDIN', 'SE-02-01', 'TTK', '1920'),
...
('1201192036', '3', '0', 'DIANA PUSPITA', 'SE-02-01', 'MSK', '1920'),
...
CREATE TABLE `usergroup` (
  ...
  `GROUPASID` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `usergroup` (`USERGROUPID`, `GROUPNAME`, `GROUPASID`) VALUES
(1, 'Administrator', NULL),
(2, 'Fakultas', NULL),
(3, 'Bagian Pelayanan Akademik', NULL),
(4, 'Pembimbing Akademik', NULL),
(5, 'Pembimbing Lapangan', NULL),
(6, 'Penguji', NULL),
(7, 'Mahasiswa', NULL);
...
INSERT INTO `users` (`id`, `email`, `username`, `password_hash`, `reset_hash`, `reset_at`, `reset_expires`, `activate_hash`, `status`, `status_message`, `active`, `force_pass_reset`, `created_at`, `updated_at`, `deleted_at`, `usergroupid`) VALUES
(1, 'user@gmail.com', 'user', '$2y$10$i9UULNpwHQ30kgj7pmCWru/Q/UY5AYErIJSoVIdM15jis6m9sMkea', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '2021-01-15 23:12:25', '2021-10-18 20:30:48', NULL, 7),
(2, 'feedeewepe@gmail.com', 'feedeewepe', '$2y$10$sUiqqGChs0D3vtY4hXcHnOcDRXWLfLAYwR/Ya16hjY3p4rK9Dipwa', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '2021-08-09 23:08:02', '2021-08-09 23:08:02', NULL, 1),
(9, 'fidiwputro@ittelkom-sby.ac.id', 'fwp', '$2y$10$66YaE0Pcs7CIbDJgDdb.KuytHCyGyFwMeWT.cb4vRG0Eq0MNizzIS', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '2021-08-17 08:46:05', '2021-10-18 21:48:40', NULL, 2),
(10, 'se@ittelkom-sby.ac.id', 'serpl', '$2y$10$9dBLLipH0MXlXgRLNgq5n.NVhAo2OhCMedPFQTaq378ngij7F.PKG', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '2021-08-17 08:47:46', '2021-08-19 09:07:39', NULL, 4),
(13, 'bpa@tes.aja', 'bpa', '$2y$10$H2hT0g0ufIhffXEYRMCksObwnzv88Vg3nLxgQmYGx8bRu90BIPJey', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '2021-08-19 09:05:00', '2021-08-19 09:05:10', NULL, 3),
(14, 'lap@tes.aja', 'lap', '$2y$10$UTiy6YxkaSGo3WiTkJd3N.zpuFFE39Dx1ssmSra1xDwQjk1s7WWPq', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, '2021-08-19 09:06:05', '2021-08-19 09:06:05', NULL, 5),
(15, 'uji@tes.aja', 'uji', '$2y$10$6.0Tv5vk9yJ0yEwZB.jA..KLwh1LbZUU4Ui1m7.GrxxygUuCiL.OW', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, '2021-08-19 09:06:49', '2021-08-19 09:06:49', NULL, 6);
...
ALTER TABLE `user`
  ...
  ADD KEY `fk_user_usergroup1_idx` (`USERGROUPID`);
...
ALTER TABLE `users`
  ...
  ADD KEY `FK_users_usergroup` (`usergroupid`);
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `fk_user_usergroup1` FOREIGN KEY (`USERGROUPID`) REFERENCES `usergroup` (`USERGROUPID`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `FK_usersgroup` FOREIGN KEY (`usergroupid`) REFERENCES `usergroup` (`USERGROUPID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
