                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active ps-0" id="group-tab" data-bs-toggle="tab" href="#tabgroup" role="tab" aria-controls="tabgroup" aria-selected="true">
                                                Data Jadwal Kerja Praktek Mahasiswa
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="d-sm-flex justify-content-between align-items-start">
                                                            <div>
                                                                <h2 class="card-title fs-6 card-title-dash">Daftar Data Jadwal Kerja Praktek Mahasiswa</h2>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <table class="table select-table">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    ?>
                                                                        <tr>
                                                                            <td>
                                                                                <?php foreach ($dataJadwal as $dataTeam) {
