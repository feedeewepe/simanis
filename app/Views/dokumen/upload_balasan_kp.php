			...
			<div class="card mb-4">
				<div class="card-body">
					...
					<div class="modal-body">
						<form id="formdaftarkp" action="<?= base_url('dokumen/upload_balasanKP'); ?>" method="post" enctype="multipart/form-data">
							<?= csrf_field(); ?>
							<div class="row">
								<div class="home-tab">
									<div class="d-sm-flex align-items-center justify-content-between border-bottom">
										<ul class="nav nav-tabs" role="tablist">
											<li class="nav-item">
												<a class="nav-link active ps-0" id="group-tab" data-bs-toggle="tab" href="#tabgroup" role="tab" aria-controls="tabgroup" aria-selected="true">Surat Balasan Kerja Praktek</a>
											</li>
											<!-- <li class="nav-item">
