            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="modal-body">
                        <form id="formdaftarkp" action="<?= base_url('dokumen/file_revisi'); ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="row">
                                <div class="home-tab">
                                    <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active ps-0" id="group-tab" data-bs-toggle="tab" href="#tabgroup" role="tab" aria-controls="tabgroup" aria-selected="true">Upload hasil revisi laporan KP</a>
                                            </li>
                                            <!-- <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" id="daftar-tab" data-bs-toggle="tab" href="#tabdaftar" role="tab" aria-selected="false">Pendaftaran</a>
                                    ...
                                    <div class="form-group mt-1">
                                        <label for="Masukan surat Balasan"></label>
                                        <input type="file" name="revisilaporan" class="form-control upload" autocomplete="off" id="suratbalasan">

                                    </div>
                                    <div class="form-group">
                                        <button type="reset" id="btn-cancel-company" class="btn btn-secondary btn-sm text-dark">Cancel</button>
                                        <button type="submit" id="btn-submit-company" class="btn btn-primary btn-sm text-light">Submit</button>
                                    </div>
